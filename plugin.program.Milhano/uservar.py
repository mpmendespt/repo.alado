...
ADDONTITLE     = '[B][COLOR yellow]Assistente Ares Team Milhano Wizard[/COLOR][/B]'
BUILDERNAME    = 'Ares Team Milhano Wizard/Builds'
...
HIDECONTACT    = 'No'
# You can add \n to do line breaks
CONTACT        = 'Obrigado por usar o instalador Team Milhano.'
...
# Font size of header
FONTHEADER     = 'Font25'
HEADERMESSAGE  = 'Ares Team Milhano Wizard/Builds '
# url to image if using Image 424x180
HEADERIMAGE    = ''
# Font for Notification Window
FONTSETTINGS   = 'Font12'
# Background for Notification Window
BACKGROUND     = 'https://cld.pt/dl/download/2d1be4be-f641-4b94-8ec8-84ec12c72660/photo_2020-05-03_15-36-30.jpg'
############################Milhano#############################