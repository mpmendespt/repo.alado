...
def buildWizard(name, type, theme=None, over=False):
	...
	if type == 'gui':
		...
		if yes:
			...
			else: DIALOG.ok(ADDONTITLE, "[COLOR %s]Obrigado por escolher a ares milhano, para salvar as alteracoes e finalizar a instalacao, voce agora precisa forcar o fechemanto do Kodi, por favor, pressione OK para encerrar o Kodi[/COLOR]" % COLOR2); wiz.killxbmc('true')
		else:
